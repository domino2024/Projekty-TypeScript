...
const PYTANIA: Pytanie[] = [
  ...
  // Poziom 2
  {
    pytanie: "Który z tych napojów zawiera kofeinę?",
    odpowiedzi: ["Woda", "Herbata", "Sok jabłkowy", "Kompot"],
    poprawna: "B",
    poziom: 2,
  },
  {
  ...
  {
    pytanie: "Jak ma na imię Kopciuszek w baśni?",
  ...
  // Poziom 3
  {
    ...
    odpowiedzi: ["Złoto", "Tlen", "Srebro", "Cyna"],
    poprawna: "B",
    poziom: 3,
  },
  {
    pytanie: "Jak nazywa się największy ocean na Ziemi?",
    odpowiedzi: ["Atlantycki", "Indyjski", "Spokojny (Pacyfik)", "Arktyczny"],
    poprawna: "C",
    poziom: 3,
  },
  {
    pytanie: "W którym kraju leży Piza ze słynną wieżą?",
    odpowiedzi: ["Hiszpania", "Włochy", "Francja", "Portugalia"],
    poprawna: "B",
    poziom: 3,
  },
  // Poziom 4
  {
    pytanie: "Ile wynosi liczba π z dokładnością do dwóch miejsc po przecinku?",
    odpowiedzi: ["3,12", "3,14", "3,16", "3,18"],
    poprawna: "B",
    poziom: 4,
  },
  {
    pytanie: "Który kontynent jest najmniejszy powierzchniowo?",
    odpowiedzi: ["Australia", "Europa", "Antarktyda", "Ameryka Południowa"],
    poprawna: "A",
    poziom: 4,
  },
  {
  ...
  {
    pytanie: "Jak nazywa się najwyższy szczyt świata?",
    odpowiedzi: ["K2", "Mount Everest", "Kilimandżaro", "Mont Blanc"],
    poprawna: "B",
    poziom: 5,
  },
  {
    pytanie: "W jakim mieście gra klub piłkarski FC Barcelona?",
  ...
  // Poziom 6
  {
    pytanie: "Który instrument ma klapy i stroik?",
    odpowiedzi: ["Klarnet", "Fortepian", "Skrzypce", "Bęben"],
    poprawna: "A",
    poziom: 6,
  },
  {
    pytanie: "Który gaz dominuje w atmosferze Ziemi?",
    odpowiedzi: ["Tlen", "Dwutlenek węgla", "Azot", "Argon"],
    poprawna: "C",
    poziom: 6,
  },
  {
    pytanie: "W jakim języku napisano 'Don Kichota'?",
    odpowiedzi: [
      "Po włosku",
      "Po hiszpańsku",
      "Po francusku",
  ...
  // Poziom 7
  {
    pytanie: "Które miasto leży nad Wełtawą?",
    odpowiedzi: ["Praga", "Wiedeń", "Budapeszt", "Bratysława"],
    poprawna: "A",
    poziom: 7,
  },
  {
    pytanie: "Który z wymienionych to pierwiastek szlachetny?",
    odpowiedzi: ["Krypton", "Wapń", "Żelazo", "Miedź"],
    poprawna: "A",
    poziom: 7,
  },
  {
    pytanie: "Kto namalował 'Gwiaździstą noc'?",
    odpowiedzi: [
      "Claude Monet",
      "Vincent van Gogh",
      "Pablo Picasso",
  ...
  // Poziom 8
  {
    pytanie: "Jak nazywa się proces przejścia cieczy w gaz?",
    odpowiedzi: ["Sublimacja", "Parowanie", "Skraplanie", "Resublimacja"],
    poprawna: "B",
    poziom: 8,
  },
  {
    pytanie: "Który pisarz stworzył Sherlocka Holmesa?",
    odpowiedzi: [
      "Agatha Christie",
      "Arthur Conan Doyle",
      "Edgar Allan Poe",
  ...
  {
    pytanie: "Które państwo nie graniczy z Polską?",
    odpowiedzi: ["Litwa", "Białoruś", "Słowacja", "Węgry"],
    poprawna: "D",
    poziom: 8,
  },
  // Poziom 9
  {
    pytanie: "W którym roku upadł Mur Berliński?",
    odpowiedzi: ["1987", "1989", "1991", "1993"],
    poprawna: "B",
    poziom: 9,
  },
  {
    pytanie: "Który organ wytwarza insulinę?",
    odpowiedzi: ["Wątroba", "Trzustka", "Śledziona", "Tarczyca"],
    poprawna: "B",
    poziom: 9,
  },
  {
  ...
  // Poziom 10
  {
    pytanie: "Jak nazywa się stolica Kanady?",
    odpowiedzi: ["Toronto", "Montreal", "Ottawa", "Vancouver"],
    poprawna: "C",
    poziom: 10,
  },
  {
    pytanie: "Który język ma najwięcej native speakerów?",
    odpowiedzi: ["Angielski", "Hiszpański", "Mandaryński", "Hindustani"],
    poprawna: "C",
    poziom: 10,
  },
  {
    pytanie: "Który kompozytor był głuchy pod koniec życia?",
  ...
  // Poziom 11
  {
    pytanie: "Jak nazywa się największy księżyc Saturna?",
    odpowiedzi: ["Europa", "Ganimedes", "Tytan", "Kallisto"],
    poprawna: "C",
    poziom: 11,
  },
  {
    pytanie: "Twierdzenie Pitagorasa dotyczy jakich trójkątów?",
    odpowiedzi: [
      "Równobocznych",
      "Równoramiennych",
      "Prostokątnych",
  ...
  {
    pytanie: "Który z tych języków NIE jest językiem urzędowym Szwajcarii?",
    odpowiedzi: ["Romansz", "Włoski", "Francuski", "Hiszpański"],
    poprawna: "D",
    poziom: 11,
  },
  // Poziom 12
  {
    pytanie: "Który noblista napisał 'Historię i świadomość klasową'?",
    odpowiedzi: [
      "Karl Popper",
      "György Lukács",
      "Friedrich Hayek",
  ...
  {
    pytanie: "Który polski król jako pierwszy koronował się na Wawelu?",
    odpowiedzi: [
      "Władysław Łokietek",
      "Kazimierz Wielki",
      "Bolesław Chrobry",
  ...
  {
    pytanie: "W fizyce: stała Plancka ma wymiar...",
...
function formatPytanie(
  q: Pytanie,
  dostepneLitery: Litera[] = [...LITERY]
): string {
  const lines: string[] = [];
  lines.push("\n" + "=".repeat(60));
...
function znajdzRezerwowePytanie(
  pytania: Pytanie[],
  poziom: number,
  aktualnyIdx: number
): [number, Pytanie] | null {
  for (let i = 0; i < pytania.length; i++) {
    if (i !== aktualnyIdx && pytania[i].poziom === poziom)
      return [i, pytania[i]];
  }
  return null;
}
  ...
  try {
    ...
    while (poziomDocelowy <= 12) {
      ...
      for (let j = globalIdx; j < pytania.length; j++) {
        if (pytania[j].poziom === poziomDocelowy) {
          idx = j;
          break;
        }
      }
      ...
      for (;;) {
        ...
        if (wybor === "K") {
          if (kola.dostepne().length === 0) {
            console.log("Brak dostępnych kół ratunkowych!");
            continue;
          }
          console.log(
          ...
          if (k === "1" && !kola.uzyte["5050"]) {
            ...
            if (!res) {
              console.log(
                "Brak rezerwowego pytania na tym poziomie – nie można użyć zmiany."
              );
              continue;
            }
        ...
        if (LITERY.includes(wybor as any)) {
          ...
          if (lit === q.poprawna) {
            ...
            if (wygrana === PROG1)
              console.log("(Osiągnięto próg gwarantowany 1 000 zł)");
            if (wygrana === PROG2)
              console.log("(Osiągnięto próg gwarantowany 40 000 zł)");
            poziomDocelowy += 1;
            globalIdx = idx + 1;
            break; // następne pytanie
          } else {
            const gwarant =
              wygrana >= PROG2 ? PROG2 : wygrana >= PROG1 ? PROG1 : 0;
            console.log(
              `\nNiestety, to błędna odpowiedź. Twoja wygrana gwarantowana: ${pln(
                gwarant
              )}.`
            );
            return;
